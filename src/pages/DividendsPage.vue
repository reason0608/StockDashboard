...
<template>
  <div class="dividends space-y-6">
    ...
    <div class="panel">
      <h3 class="font-semibold">每月預估股息 <span class="text-xs text-slate-400 font-normal">依交易紀錄股數，每筆固定扣除 NT$10</span></h3>
      ...
      <p class="hint">發放日未公告的紀錄不分配至月份；每筆配息固定扣除 NT$10 匯費，沒有交易的日期視為沒有交易。</p>
    </div>
